...
exports.ContentSizeDetector = void 0;
class ContentSizeDetector {
     ...
     */
    getRoutingRecommendation(messages, systemPrompt, forceProvider) {
     ...
     */
    exceedsProviderLimit(messages, provider, systemPrompt) {
        const estimatedTokens = this.estimateTokens(messages, systemPrompt);
        if (provider === 'groq') {
...
exports.ContentSizeDetector = ContentSizeDetector;
