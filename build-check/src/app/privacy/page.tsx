                ...
                <div className="w-full px-6">
                    <article className="prose prose-invert prose-slate max-w-none">
                        ...
                        <section className="mb-10">
                            ...
                            <div className="mt-6 p-4 rounded-xl bg-card/40 border border-border/40">
                        ...
                        <section className="mb-10">
                            <h2 className="font-heading text-xl font-semibold text-foreground mb-4 flex items-center gap-3">
                                <span className="w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center text-sm text-primary font-bold">3</span>
                        ...
                        <section className="mb-10">
                            ...
                            <div className="grid gap-3 mb-4">
                                <div className="p-4 rounded-xl bg-card/40 border border-border/40 flex items-center gap-4">
                                    <span className="text-2xl">🔐</span>
                                    <div>
                                        <p className="text-white font-medium">Authentication</p>
                                        <p className="text-muted-foreground text-sm">Clerk (for secure login)</p>
                                    </div>
                                </div>
                                <div className="p-4 rounded-xl bg-card/40 border border-border/40 flex items-center gap-4">
                                    <span className="text-2xl">🤖</span>
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">Gemini (for content generation)</p>
                                    </div>
                                </div>
                                <div className="p-4 rounded-xl bg-card/40 border border-border/40 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">Neon (for storing your saved notes)</p>
                                    </div>
                                </div>
                                <div className="p-4 rounded-xl bg-card/40 border border-border/40 flex items-center gap-4">
                                    <span className="text-2xl">☁️</span>
                        ...
                        <section className="mb-10">
                            <h2 className="font-heading text-xl font-semibold text-foreground mb-4 flex items-center gap-3">
                                <span className="w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center text-sm text-primary font-bold">6</span>
                                Your Rights
                            </h2>
                            <p className="text-foreground/80 leading-relaxed mb-4">
                        ...
                        <section className="mb-10">
                            ...
                            <div className="p-4 rounded-xl bg-linear-to-r from-primary/10 to-(--brand-accent)/10 border border-primary/20">
