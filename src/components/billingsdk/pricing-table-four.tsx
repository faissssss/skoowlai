    ...
    <div className={className}>
      ...
      <div className="text-center px-4 pt-2 pb-5">
        ...
        <p className="text-slate-400 text-sm max-w-lg mx-auto leading-relaxed">
          Transform your studies with our comprehensive pricing options.
        </p>
      </div>
          ...
          <div className="grid grid-cols-2 bg-slate-800/80 rounded-lg p-0.5 border border-slate-700/50 w-full max-w-[240px]">
            <button
              ...
              className={`relative px-3 py-1.5 text-[11px] font-semibold rounded-md transition-all duration-200 cursor-pointer ${
                 interval === "monthly" ? "text-white" : "text-slate-400 hover:text-slate-200"
              }`}
            ...
            <button
              type="button"
              className={`relative px-3 py-1.5 text-[11px] font-semibold rounded-md transition-all duration-200 cursor-pointer flex items-center justify-center gap-1 ${
                interval === "yearly" ? "text-white" : "text-slate-400 hover:text-slate-200"
              }`}
      ...
      <div className="px-4 pb-2 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col h-[190px]">
              ...
              <div className="mt-auto">
                <Button
                    className="w-full bg-violet-600 hover:bg-violet-700 text-white shadow-lg shadow-violet-500/20 h-9 text-xs rounded-lg font-medium transition-all"
                    onClick={() => onPlanSelect(pro.id, interval)}
                    disabled={!!loadingPlanId}
                >
                    {loadingPlanId === pro.id ? "Processing..." : "Upgrade Now"}
                </Button>
              </div>
          </div>
