    ...
    <div className={cn("w-full text-left", className)}>
      <Card className="shadow-lg border border-slate-800 bg-slate-900">
        ...
        <CardContent className="space-y-6 px-4 sm:space-y-8 sm:px-6">
          ...
          <div className="relative overflow-hidden rounded-xl border border-slate-800 bg-slate-950 p-3 sm:p-4">
                  ...
                  <div className="mb-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <Badge
                        ...
                        className="bg-slate-800 text-slate-200 border border-slate-700 hover:bg-slate-700 text-xs font-medium shadow-sm sm:text-sm"
                      >
                      ...
                      <Badge
                        variant="outline"
                        className="border-slate-700 bg-slate-900/40 text-slate-300 text-xs shadow-sm backdrop-blur-sm sm:text-sm"
                      >
                        {currentPlan.status}
                      </Badge>
                    </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h4 className="flex items-center gap-2 text-base font-medium sm:text-lg text-slate-100">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-6">
              <div className="group rounded-lg border border-slate-800 bg-slate-950 hover:border-slate-700 p-2.5 transition-all duration-200 sm:p-3 md:bg-slate-950">
          ...
          <div className="pt-4 sm:pt-6">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {currentPlan.plan.features.map((feature, index) => (
                <div
                  key={index}
                  className="group border-slate-700 bg-slate-950 hover:border-violet-500/30 hover:bg-violet-600/5 flex items-center gap-2 rounded-lg border p-2 transition-all duration-200 sm:p-2"
                >
