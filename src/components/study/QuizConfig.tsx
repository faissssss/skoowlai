...
export default function QuizConfig({ deckId, isOpen, onClose, onGenerated, isSubscriber = false }: QuizConfigProps) {
    ...
    const typeOptions = [
        ...
        { value: 'fill-in', label: 'Fill-in', icon: <Pencil className="w-4 h-4" /> },
                                ...
                                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-border flex items-center justify-between shrink-0">
                                    <div className="flex items-center gap-2 sm:gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs sm:text-sm text-muted-foreground hidden sm:block">Configure your quiz preferences</p>
                                        </div>
                                    </div>
                                    <button
                                        onClick={onClose}
